...
opcode_def opcodes[0x100] = {
  ...
  {0x19, "add",              1,  8,  8, ARG_HL,    ARG_R,    run_op_add_hl_r},
  ...
  {0x29, "add",              1,  8,  8, ARG_HL,    ARG_R,    run_op_add_hl_r},
  ...
  {0x80, "add",              1,  4,  4, ARG_A,     ARG_X2,   run_op_add_a_x},
  {0x81, "add",              1,  4,  4, ARG_A,     ARG_X2,   run_op_add_a_x},
  {0x82, "add",              1,  4,  4, ARG_A,     ARG_X2,   run_op_add_a_x},
  {0x83, "add",              1,  4,  4, ARG_A,     ARG_X2,   run_op_add_a_x},
  {0x84, "add",              1,  4,  4, ARG_A,     ARG_X2,   run_op_add_a_x},
  {0x85, "add",              1,  4,  4, ARG_A,     ARG_X2,   run_op_add_a_x},
  {0x86, "add",              1,  8,  8, ARG_A,     ARG_X2,   run_op_add_a_x},
  {0x87, "add",              1,  4,  4, ARG_A,     ARG_X2,   run_op_add_a_x},
  {0x88, "adc",              1,  4,  4, ARG_A,     ARG_X2,   run_op_adc_a_x},
  {0x89, "adc",              1,  4,  4, ARG_A,     ARG_X2,   run_op_adc_a_x},
  {0x8A, "adc",              1,  4,  4, ARG_A,     ARG_X2,   run_op_adc_a_x},
  {0x8B, "adc",              1,  4,  4, ARG_A,     ARG_X2,   run_op_adc_a_x},
  {0x8C, "adc",              1,  4,  4, ARG_A,     ARG_X2,   run_op_adc_a_x},
  {0x8D, "adc",              1,  4,  4, ARG_A,     ARG_X2,   run_op_adc_a_x},
  {0x8E, "adc",              1,  8,  8, ARG_A,     ARG_X2,   run_op_adc_a_x},
  {0x8F, "adc",              1,  4,  4, ARG_A,     ARG_X2,   run_op_adc_a_x},

  {0x90, "sub",              1,  4,  4, ARG_A,     ARG_X2,   run_op_sub_a_x},
  {0x91, "sub",              1,  4,  4, ARG_A,     ARG_X2,   run_op_sub_a_x},
  {0x92, "sub",              1,  4,  4, ARG_A,     ARG_X2,   run_op_sub_a_x},
  {0x93, "sub",              1,  4,  4, ARG_A,     ARG_X2,   run_op_sub_a_x},
  {0x94, "sub",              1,  4,  4, ARG_A,     ARG_X2,   run_op_sub_a_x},
  {0x95, "sub",              1,  4,  4, ARG_A,     ARG_X2,   run_op_sub_a_x},
  {0x96, "sub",              1,  8,  8, ARG_A,     ARG_X2,   run_op_sub_a_x},
  {0x97, "sub",              1,  4,  4, ARG_A,     ARG_X2,   run_op_sub_a_x},
  {0x98, "subc",             1,  4,  4, ARG_A,     ARG_X2,   run_op_subc_a_x},
  {0x99, "subc",             1,  4,  4, ARG_A,     ARG_X2,   run_op_subc_a_x},
  {0x9A, "subc",             1,  4,  4, ARG_A,     ARG_X2,   run_op_subc_a_x},
  {0x9B, "subc",             1,  4,  4, ARG_A,     ARG_X2,   run_op_subc_a_x},
  {0x9C, "subc",             1,  4,  4, ARG_A,     ARG_X2,   run_op_subc_a_x},
  {0x9D, "subc",             1,  4,  4, ARG_A,     ARG_X2,   run_op_subc_a_x},
  {0x9E, "subc",             1,  8,  8, ARG_A,     ARG_X2,   run_op_subc_a_x},
  {0x9F, "subc",             1,  4,  4, ARG_A,     ARG_X2,   run_op_subc_a_x},

  {0xA0, "and",              1,  4,  4, ARG_A,     ARG_X2,   run_op_and_a_x},
  {0xA1, "and",              1,  4,  4, ARG_A,     ARG_X2,   run_op_and_a_x},
  {0xA2, "and",              1,  4,  4, ARG_A,     ARG_X2,   run_op_and_a_x},
  {0xA3, "and",              1,  4,  4, ARG_A,     ARG_X2,   run_op_and_a_x},
  {0xA4, "and",              1,  4,  4, ARG_A,     ARG_X2,   run_op_and_a_x},
  {0xA5, "and",              1,  4,  4, ARG_A,     ARG_X2,   run_op_and_a_x},
  {0xA6, "and",              1,  8,  8, ARG_A,     ARG_X2,   run_op_and_a_x},
  {0xA7, "and",              1,  4,  4, ARG_A,     ARG_X2,   run_op_and_a_x},
  {0xA8, "xor",              1,  4,  4, ARG_A,     ARG_X2,   run_op_xor_a_x},
  {0xA9, "xor",              1,  4,  4, ARG_A,     ARG_X2,   run_op_xor_a_x},
  {0xAA, "xor",              1,  4,  4, ARG_A,     ARG_X2,   run_op_xor_a_x},
  {0xAB, "xor",              1,  4,  4, ARG_A,     ARG_X2,   run_op_xor_a_x},
  {0xAC, "xor",              1,  4,  4, ARG_A,     ARG_X2,   run_op_xor_a_x},
  {0xAD, "xor",              1,  4,  4, ARG_A,     ARG_X2,   run_op_xor_a_x},
  {0xAE, "xor",              1,  8,  8, ARG_A,     ARG_X2,   run_op_xor_a_x},
  {0xAF, "xor",              1,  4,  4, ARG_A,     ARG_X2,   run_op_xor_a_x},

  {0xB0, "or",               1,  4,  4, ARG_A,     ARG_X2,   run_op_or_a_x},
  {0xB1, "or",               1,  4,  4, ARG_A,     ARG_X2,   run_op_or_a_x},
  {0xB2, "or",               1,  4,  4, ARG_A,     ARG_X2,   run_op_or_a_x},
  {0xB3, "or",               1,  4,  4, ARG_A,     ARG_X2,   run_op_or_a_x},
  {0xB4, "or",               1,  4,  4, ARG_A,     ARG_X2,   run_op_or_a_x},
  {0xB5, "or",               1,  4,  4, ARG_A,     ARG_X2,   run_op_or_a_x},
  {0xB6, "or",               1,  8,  8, ARG_A,     ARG_X2,   run_op_or_a_x},
  {0xB7, "or",               1,  4,  4, ARG_A,     ARG_X2,   run_op_or_a_x},
  {0xB8, "cp",               1,  4,  4, ARG_A,     ARG_X2,   run_op_cp_a_x},
  {0xB9, "cp",               1,  4,  4, ARG_A,     ARG_X2,   run_op_cp_a_x},
  {0xBA, "cp",               1,  4,  4, ARG_A,     ARG_X2,   run_op_cp_a_x},
  {0xBB, "cp",               1,  4,  4, ARG_A,     ARG_X2,   run_op_cp_a_x},
  {0xBC, "cp",               1,  4,  4, ARG_A,     ARG_X2,   run_op_cp_a_x},
  {0xBD, "cp",               1,  4,  4, ARG_A,     ARG_X2,   run_op_cp_a_x},
  {0xBE, "cp",               1,  8,  8, ARG_A,     ARG_X2,   run_op_cp_a_x},
  {0xBF, "cp",               1,  4,  4, ARG_A,     ARG_X2,   run_op_cp_a_x},
  ...
  {0xC6, "add",              2,  8,  8, ARG_A,     ARG_D8,   run_op_add_a_d8},
  ...
  {0xCE, "adc",              2,  8,  8, ARG_A,     ARG_D8,   run_op_adc_a_d8},
  ...
  {0xD6, "sub",              2,  8,  8, ARG_A,     ARG_D8,   run_op_sub_a_d8},
  ...
  {0xDE, "subc",             2,  8,  8, ARG_A,     ARG_D8,   run_op_subc_a_d8},
  ...
  {0xE6, "and",              2,  8,  8, ARG_A,     ARG_D8,   run_op_and_a_d8},
  ...
  {0xEE, "xor",              2,  8,  8, ARG_A,     ARG_D8,   run_op_xor_a_d8},
  ...
  {0xF6, "or",               2,  8,  8, ARG_A,     ARG_D8,   run_op_or_a_d8},
  ...
  {0xFE, "cp",               2,  8,  8, ARG_A,     ARG_D8,   run_op_cp_a_d8},
